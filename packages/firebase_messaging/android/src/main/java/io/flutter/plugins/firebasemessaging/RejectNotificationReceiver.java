        ...
        db.collection("orders").document(orderId).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot orderDoc) {
                ...
                if (PENDING.equals(orderStatus)) {
                    ...
                    showApprovedNotification(context, "Brak produktu: " + menuName, notificationId);
                }
                if (batch != null) {
                    batch.commit().addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            pushNotificationMessage.put("message", "Brak produktu: " + menuName);
                            pushNotificationMessage.put("messageEN", "Out of stock: " + menuNameEN);
